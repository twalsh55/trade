...
class LeadAmbientMemorySummaryDTO:
    ...
    attention_source_labels: list[str]
    paused_source_labels: list[str]
...
def build_lead_ambient_memory_summary_dto(summary: LeadAmbientMemorySummary | None) -> LeadAmbientMemorySummaryDTO | None:
    ...
    return LeadAmbientMemorySummaryDTO(
        ...
        suggested_action_kind=summary.suggested_action_kind,
        ...
        attention_source_labels=list(summary.attention_source_labels),
        paused_source_labels=list(summary.paused_source_labels),
    )
